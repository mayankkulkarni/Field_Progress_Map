...
def get_precinct_viz(precinct, precinct_cluster_dict, volunteers):
    ...
    filename = 'file:///' + 'Users/akankshadiwedy/Downloads/FieldProgressAlgorithm/' + 'initial_map.html'
    ...
    with open("result_map.html", "w") as handler:
    	handler.write(viz.create_html())
    handler.close()
    filename = 'file:///' + 'Users/akankshadiwedy/Downloads/FieldProgressAlgorithm/' + 'result_map.html'
    webbrowser.open_new_tab(filename)
...
precinct_cluster_dict[precinct_input] = get_cluster_per_precint(precinct_input, vdf, pdf, volunteers)

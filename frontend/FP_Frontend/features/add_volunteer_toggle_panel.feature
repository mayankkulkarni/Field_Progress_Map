Feature: Adding a new volunteer and toggling the input panel
    ...
    Scenario:
        ...
        When I fill out volunteer "Ronald" with availability "3"
        And I add a new volunteer card
        And I fill out volunteer "Jerry" with availability "2"
        And I click the "Toggle Input" button
        And I click the "Toggle Input" button
        And I click the "Toggle Input" button
        And I click the "Toggle Input" button
        Then I should see a card for "Jerry" with availability "2"
        And I should see a card for "Ronald" with availability "3"

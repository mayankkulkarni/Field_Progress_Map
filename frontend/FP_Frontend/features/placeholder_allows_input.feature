Feature: Placeholder text should vanish as soon as a user begins typing
    ...
    Scenario:
        ...
        And I see a card with placeholder name "John Doe" and placeholder availability "in hrs"
        When I fill out volunteer "Stannis" with availability "12"
        Then I should see a card for "Stannis" with availability "12"